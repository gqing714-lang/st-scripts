/* 正式版：状态连续台词模式 / 平滑逐字头像心声框 / 原生 dialog 设置界面 / 可调颜色和字体 / 任意状态头像池
...
(() => {
  const SCRIPT_FLAG = '__ST_HEART_HB_DIALOG_RELEASE_STATUS_FONT__';
  ...
  function boot() {
    ...
    console.log('[头像心声框 正式版] loaded：状态连续台词模式 / 原生 dialog 设置界面 / 可调颜色和字体 / 任意状态头像池');
  }
