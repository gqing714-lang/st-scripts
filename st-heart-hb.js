/* 头像心声框：可视化头像配置版 / 任意心情名 / 轻量逐字 / 紫红底色 / 聊天内设置面板修正版 / 保留最新5个
...
(() => {
  if (window.__ST_HEART_HB_CONFIGURABLE_AVATAR_KEEP5_INLINESETTINGS_V2__) return;
  window.__ST_HEART_HB_CONFIGURABLE_AVATAR_KEEP5_INLINESETTINGS_V2__ = true;
  ...
  function openAvatarSettingsPanel() {
    ...
    overlay.className = 'st-heart-hb-inline-settings';
    ...
    const settingsHost = getSettingsPanelHost(doc);
    settingsHost.appendChild(overlay);
  ...
  console.log('[头像心声框：可视化头像配置版 / 任意心情 / 聊天内设置面板修正 / 保留最新5个] loaded');
})();
